...
public class FrontShader extends DefaultShader {
	...
	public final static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.internal("data/shaders/depthVs.glsl").readString();
	...
	public final static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.internal("data/shaders/depthFs.glsl").readString();
	...
	public FrontShader (final Renderable renderable) {
		this(renderable, new Config());
	}

	public FrontShader (final Renderable renderable, final Config config) {
		this(renderable, config, createPrefix(renderable, config));
	}

	public FrontShader (final Renderable renderable, final Config config, final String prefix) {
		this(renderable, config, prefix, config.vertexShader != null ? config.vertexShader : getDefaultVertexShader(),
			config.fragmentShader != null ? config.fragmentShader : getDefaultFragmentShader());
	}

	public FrontShader (final Renderable renderable, final Config config, final String prefix, final String vertexShader,
